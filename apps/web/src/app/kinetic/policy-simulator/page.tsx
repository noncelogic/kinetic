  ...
  return (
    <PageContent>
      <PageHeader
        ...
        description="Policy-to-Code translation demo"
        actions={
          <button onClick={handleToggleCode} className="btn-secondary text-sm px-4 py-2">
        ...
        <div className="glass-card-elevated overflow-hidden">
          <div className="px-6 py-4 border-b border-[var(--border)] flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-medium">Policy Document</h2>
            </div>
            <span className="text-xs text-[var(--text-muted)] font-mono">Human-readable</span>
          </div>
          <div className="p-6">
            <pre className="text-sm leading-relaxed">
              {POLICY_LINES.map((line, index) => {
                ...
                if (isHighlighted) {
                  ...
                  textColorClass = 'text-accent font-semibold';
                } else if (isSeparator) {
                  textColorClass = 'text-[var(--text-muted)]';
                }
                ...
                return (
                  <div
                    ...
                    className={`
                      ...
                      ${
                        isHighlighted ? 'bg-red-500/30 border-l-4 border-red-500 animate-pulse' : ''
                      }
                      ${textColorClass}
                    `}
                  >
                    <span className="text-[var(--text-muted)] select-none mr-4 text-xs w-6 inline-block">
          ...
          <div className="glass-card-elevated overflow-hidden">
            <div className="px-6 py-4 border-b border-[var(--border)] flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-medium">Zod Guardrail</h2>
              </div>
              <span className="text-xs text-[var(--text-muted)] font-mono">Machine-enforced</span>
            </div>
      ...
      {/* Action Panel */}
      <div className="mt-6 glass-card-elevated p-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              ...
              className={`
                ...
                ${
                  isAnimating
                    ? 'bg-[var(--bg-secondary)] text-[var(--text-muted)] cursor-not-allowed'
                    : 'bg-gradient-to-r from-green-500 to-teal-500 text-white hover:shadow-lg hover:shadow-green-500/25 hover:scale-105'
                }
              `}
            >
              ✓ Comply (2 approvals)
            ...
            {result !== null && (
              <button onClick={reset} className="px-6 py-3 rounded-xl font-medium btn-secondary">
                Reset
              </button>
            )}
          </div>
      ...
      {result !== null && (
        ...
        >
          <div
            className={`px-6 py-4 border-b ${result.success ? 'border-green-500/30' : 'border-red-500/30'}`}
          >
            <div className="flex items-center gap-3">
              <div
                className={`
      ...
      <div className="mt-6 grid lg:grid-cols-3 gap-6">
        <div className="glass-card-elevated p-6">
          ...
          <h3 className="font-medium mb-2">Policy as Code</h3>
          <p className="text-[var(--text-muted)] text-sm">
        ...
        <div className="glass-card-elevated p-6">
          ...
          <h3 className="font-medium mb-2">Guardrail Enforcement</h3>
          <p className="text-[var(--text-muted)] text-sm">
        ...
        <div className="glass-card-elevated p-6">
          ...
          <h3 className="font-medium mb-2">Violation Traceability</h3>
          <p className="text-[var(--text-muted)] text-sm">
